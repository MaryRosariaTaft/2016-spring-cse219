...
public class AppFileController {
    ...
    // AS WELL AS WHETHER THE LOAD BUTTON HAS BEEN CLICKED
    // (because it doesn't work... see the dialog it invokes for details.)
    ...
    public void markAsEdited(AppGUI gui) {
        ...
        // LET THE UI KNOW
        gui.updateToolbarControls(saved, loadButtonClicked);
    }
	...
	PropertiesManager props = PropertiesManager.getPropertiesManager();
		...
		currentWorkFile = null;
                ...
                app.getGUI().updateToolbarControls(saved, loadButtonClicked);
     ...
     */
     public void handleLoadRequest(){
         ...
         // EXPLAIN THE USELESSNESS OF THE LOAD BUTTON TO THE USER
	AppMessageDialogSingleton dialog = AppMessageDialogSingleton.getSingleton();
	PropertiesManager props = PropertiesManager.getPropertiesManager();
        String message = "To whom it may concern:\n\nI added the Load button, ";
        message += "but I didn't implement its functionality.  \n";
        message += "This dialog is to let you know that the button itself ";
        message += "works fine, \nbut it does absolutely nothing save invoke ";
        message += "this dialog.\nThe Load button will now be disabled.\n\n-Mary Taft";
        dialog.show("Load Button is Useless", message);
