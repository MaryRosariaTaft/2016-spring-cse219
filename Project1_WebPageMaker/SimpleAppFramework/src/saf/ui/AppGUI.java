...
public class AppGUI implements AppStyleArbiter {
     ...
     * 
     * @param loadButtonClicked Describes whether the Load Button has been
     *  clicked (at all) by the user (note: see the dialog it invokes
     *  for details as to this behavior)
     */
    public void updateToolbarControls(boolean saved, boolean loadButtonClicked) {
	...
	newButton.setDisable(false);
        loadButton.setDisable(loadButtonClicked);
